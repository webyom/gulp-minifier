(function() {
  var CleanCSS, EOL, HtmlMinifier, UglifyJS, _, fs, getErrorStack, gutil, logErr, path, through;
  ...
  module.exports.minify = function(file, opt) {
    var content, e, extname, fileName, includeExtNameMap, keptComment, minifyCSS, minifyHTML, minifyJS, newFile, result, source, sourceMapUrl;
